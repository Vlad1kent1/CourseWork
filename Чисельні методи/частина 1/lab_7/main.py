...
result, err, iterations = midpoint_rule(a, b, n, p, eps)
print("Midpoint Rule:", result, "\tError:", err, "\tIterations:", iterations)

result, err, iterations = trapezoidal_rule(a, b, n, p, eps)
print("Trapezoidal Rule:", result, "\tError:", err, "\tIterations:", iterations)

result, err, iterations = simpson_rule(a, b, n, p, eps)
print("Simpson's Rule:", result, "\tError:", err, "\tIterations:", iterations)
